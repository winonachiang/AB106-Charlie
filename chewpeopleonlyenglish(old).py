...
def crawlPage(url):
    ...
    articles_dict = {}
    contents = soup.select('div.main.col-md-8 > div.article-content.clearfix > p')
    contents_dict = {}
    ...
    articles_dict['source'] = 'https://chewpeople.com.tw/'
    print(articles_dict)

    return articles_dict


f = open('C:\\Users\\CF_NB.CF.000\\uncrawledurls\\chewpeopleonlyenglish.txt','rt')
