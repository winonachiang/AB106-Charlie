...
def getDigiphoto(url):
    ...
    articles_dict = {}
    contents = soup.select('#main > div.content > p')
    contents_dict = {}
...
#f = open('C:\\Users\\CF_NB.CF.000\\uncrawledurls\\digiphoto(old).txt','rt')
...
getDigiphoto('https://digiphoto.techbang.com/posts/8689')
