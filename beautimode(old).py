...
def getBeautimode(url):
    ...
    articles_dict = {}
    contents = soup.select('div.row.article_content.main_article > div > div > p')
    contents_dict = {}
...
getBeautimode('http://www.beautimode.com/article/content/83371/')
