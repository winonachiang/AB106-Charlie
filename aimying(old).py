...
def getaimying(url):
    ...
    articles_dict = {}
    contents = soup.select('#banners > div')
    contents_dict = {}
...
#f = open('C:\\Users\\CF_NB.CF.000\\uncrawledurls(old)\\aimying(old).txt','rt')
...
getaimying('http://www.aimying.com/a/chuangtoujie/chuangye/98.html')
