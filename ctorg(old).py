...
def crawlPage(url):
    ...
    try: #例外處理，把HTTP404或是403、400的跳過
        contents = soup.select('div.single-meta > div.single-post-content')
    except:
        pass
    contents_dict = {}
    ...
    articles_dict['source'] = 'https://www.ct.org.tw/'
    print(articles_dict)

    return articles_dict


f = open('C:\\Users\\CF_NB.CF.000\\uncrawledurls\\ctorg(old).txt','rt')
